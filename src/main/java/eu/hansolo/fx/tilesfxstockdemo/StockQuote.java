...
public class StockQuote {
    ...
    public StockQuote(final JSONObject JSON_QUOTE) {
        ...
        timestamp     = LocalDateTime.parse(JSON_QUOTE.get("Timestamp").toString().replace("UTC", "EDT"), FORMATTER);
    ...
    public void setTimestamp(final LocalDateTime TIMESTAMP) { timestamp = TIMESTAMP; }
